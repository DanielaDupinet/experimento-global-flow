...
export const SentimentVerySatisfiedIcon = ({ size = 20, color, opacity = 1 }: IconProps) => {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 20 20" fill="none">
      ...
      <Path
        d="M12.5 8.33333C12.5 10.6345 10.6345 12.5 8.33333 12.5C6.03215 12.5 4.16667 10.6345 4.16667 8.33333H12.5Z"
        fill={fill}
        fillOpacity={opacity}
      />
      <Path
